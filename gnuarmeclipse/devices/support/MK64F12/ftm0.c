...
static void mk64f12_ftm_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
    ...
    state->u.k6.reg.csc[2] = cm_object_get_child_by_name(obj, "C2SC");
    state->u.k6.reg.csc[3] = cm_object_get_child_by_name(obj, "C3SC");
    state->u.k6.reg.csc[4] = cm_object_get_child_by_name(obj, "C4SC");
    state->u.k6.reg.csc[5] = cm_object_get_child_by_name(obj, "C5SC");
    state->u.k6.reg.csc[6] = cm_object_get_child_by_name(obj, "C6SC");
    state->u.k6.reg.csc[7] = cm_object_get_child_by_name(obj, "C7SC");
    state->u.k6.reg.cv[0] = cm_object_get_child_by_name(obj, "C0V");
    state->u.k6.reg.cv[1] = cm_object_get_child_by_name(obj, "C1V");
    state->u.k6.reg.cv[2] = cm_object_get_child_by_name(obj, "C2V");
    state->u.k6.reg.cv[3] = cm_object_get_child_by_name(obj, "C3V");
    state->u.k6.reg.cv[4] = cm_object_get_child_by_name(obj, "C4V");
    state->u.k6.reg.cv[5] = cm_object_get_child_by_name(obj, "C5V");
    state->u.k6.reg.cv[6] = cm_object_get_child_by_name(obj, "C6V");
    state->u.k6.reg.cv[7] = cm_object_get_child_by_name(obj, "C7V");
    ...
    // C2SC bitfields.
    state->u.k6.fld.csc[2].dma = cm_object_get_child_by_name(state->u.k6.reg.csc[2], "DMA");
    state->u.k6.fld.csc[2].elsa = cm_object_get_child_by_name(state->u.k6.reg.csc[2], "ELSA");
    state->u.k6.fld.csc[2].elsb = cm_object_get_child_by_name(state->u.k6.reg.csc[2], "ELSB");
    state->u.k6.fld.csc[2].msa = cm_object_get_child_by_name(state->u.k6.reg.csc[2], "MSA");
    state->u.k6.fld.csc[2].msb = cm_object_get_child_by_name(state->u.k6.reg.csc[2], "MSB");
    state->u.k6.fld.csc[2].chie = cm_object_get_child_by_name(state->u.k6.reg.csc[2], "CHIE");
    state->u.k6.fld.csc[2].chf = cm_object_get_child_by_name(state->u.k6.reg.csc[2], "CHF");
    // C3SC bitfields.
    state->u.k6.fld.csc[3].dma = cm_object_get_child_by_name(state->u.k6.reg.csc[3], "DMA");
    state->u.k6.fld.csc[3].elsa = cm_object_get_child_by_name(state->u.k6.reg.csc[3], "ELSA");
    state->u.k6.fld.csc[3].elsb = cm_object_get_child_by_name(state->u.k6.reg.csc[3], "ELSB");
    state->u.k6.fld.csc[3].msa = cm_object_get_child_by_name(state->u.k6.reg.csc[3], "MSA");
    state->u.k6.fld.csc[3].msb = cm_object_get_child_by_name(state->u.k6.reg.csc[3], "MSB");
    state->u.k6.fld.csc[3].chie = cm_object_get_child_by_name(state->u.k6.reg.csc[3], "CHIE");
    state->u.k6.fld.csc[3].chf = cm_object_get_child_by_name(state->u.k6.reg.csc[3], "CHF");
    // C4SC bitfields.
    state->u.k6.fld.csc[4].dma = cm_object_get_child_by_name(state->u.k6.reg.csc[4], "DMA");
    state->u.k6.fld.csc[4].elsa = cm_object_get_child_by_name(state->u.k6.reg.csc[4], "ELSA");
    state->u.k6.fld.csc[4].elsb = cm_object_get_child_by_name(state->u.k6.reg.csc[4], "ELSB");
    state->u.k6.fld.csc[4].msa = cm_object_get_child_by_name(state->u.k6.reg.csc[4], "MSA");
    state->u.k6.fld.csc[4].msb = cm_object_get_child_by_name(state->u.k6.reg.csc[4], "MSB");
    state->u.k6.fld.csc[4].chie = cm_object_get_child_by_name(state->u.k6.reg.csc[4], "CHIE");
    state->u.k6.fld.csc[4].chf = cm_object_get_child_by_name(state->u.k6.reg.csc[4], "CHF");
    // C5SC bitfields.
    state->u.k6.fld.csc[5].dma = cm_object_get_child_by_name(state->u.k6.reg.csc[5], "DMA");
    state->u.k6.fld.csc[5].elsa = cm_object_get_child_by_name(state->u.k6.reg.csc[5], "ELSA");
    state->u.k6.fld.csc[5].elsb = cm_object_get_child_by_name(state->u.k6.reg.csc[5], "ELSB");
    state->u.k6.fld.csc[5].msa = cm_object_get_child_by_name(state->u.k6.reg.csc[5], "MSA");
    state->u.k6.fld.csc[5].msb = cm_object_get_child_by_name(state->u.k6.reg.csc[5], "MSB");
    state->u.k6.fld.csc[5].chie = cm_object_get_child_by_name(state->u.k6.reg.csc[5], "CHIE");
    state->u.k6.fld.csc[5].chf = cm_object_get_child_by_name(state->u.k6.reg.csc[5], "CHF");
    // C6SC bitfields.
    state->u.k6.fld.csc[6].dma = cm_object_get_child_by_name(state->u.k6.reg.csc[6], "DMA");
    state->u.k6.fld.csc[6].elsa = cm_object_get_child_by_name(state->u.k6.reg.csc[6], "ELSA");
    state->u.k6.fld.csc[6].elsb = cm_object_get_child_by_name(state->u.k6.reg.csc[6], "ELSB");
    state->u.k6.fld.csc[6].msa = cm_object_get_child_by_name(state->u.k6.reg.csc[6], "MSA");
    state->u.k6.fld.csc[6].msb = cm_object_get_child_by_name(state->u.k6.reg.csc[6], "MSB");
    state->u.k6.fld.csc[6].chie = cm_object_get_child_by_name(state->u.k6.reg.csc[6], "CHIE");
    state->u.k6.fld.csc[6].chf = cm_object_get_child_by_name(state->u.k6.reg.csc[6], "CHF");
    // C7SC bitfields.
    state->u.k6.fld.csc[7].dma = cm_object_get_child_by_name(state->u.k6.reg.csc[7], "DMA");
    state->u.k6.fld.csc[7].elsa = cm_object_get_child_by_name(state->u.k6.reg.csc[7], "ELSA");
    state->u.k6.fld.csc[7].elsb = cm_object_get_child_by_name(state->u.k6.reg.csc[7], "ELSB");
    state->u.k6.fld.csc[7].msa = cm_object_get_child_by_name(state->u.k6.reg.csc[7], "MSA");
    state->u.k6.fld.csc[7].msb = cm_object_get_child_by_name(state->u.k6.reg.csc[7], "MSB");
    state->u.k6.fld.csc[7].chie = cm_object_get_child_by_name(state->u.k6.reg.csc[7], "CHIE");
    state->u.k6.fld.csc[7].chf = cm_object_get_child_by_name(state->u.k6.reg.csc[7], "CHF");
    // C0V bitfields.
    ...
    // C2V bitfields.
    state->u.k6.fld.cv[2].val = cm_object_get_child_by_name(state->u.k6.reg.cv[2], "VAL");
    // C3V bitfields.
    state->u.k6.fld.cv[3].val = cm_object_get_child_by_name(state->u.k6.reg.cv[3], "VAL");
    // C4V bitfields.
    state->u.k6.fld.cv[4].val = cm_object_get_child_by_name(state->u.k6.reg.cv[4], "VAL");
    // C5V bitfields.
    state->u.k6.fld.cv[5].val = cm_object_get_child_by_name(state->u.k6.reg.cv[5], "VAL");
    // C6V bitfields.
    state->u.k6.fld.cv[6].val = cm_object_get_child_by_name(state->u.k6.reg.cv[6], "VAL");
    // C7V bitfields.
    state->u.k6.fld.cv[7].val = cm_object_get_child_by_name(state->u.k6.reg.cv[7], "VAL");
