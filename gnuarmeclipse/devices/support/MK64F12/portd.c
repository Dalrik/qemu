...
static void mk64f12_port_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
    ...
    state->u.k6.reg.dfer = cm_object_get_child_by_name(obj, "DFER");
    state->u.k6.reg.dfcr = cm_object_get_child_by_name(obj, "DFCR");
    state->u.k6.reg.dfwr = cm_object_get_child_by_name(obj, "DFWR");
    // PCR0 bitfields.
    ...
    // DFER bitfields.
    state->u.k6.fld.dfer.dfe = cm_object_get_child_by_name(state->u.k6.reg.dfer, "DFE");

    // DFCR bitfields.
    state->u.k6.fld.dfcr.cs = cm_object_get_child_by_name(state->u.k6.reg.dfcr, "CS");

    // DFWR bitfields.
    state->u.k6.fld.dfwr.filt = cm_object_get_child_by_name(state->u.k6.reg.dfwr, "FILT");
}
...
static void kinetis_port_realize_callback(DeviceState *dev, Error **errp)
{
    ...
    case KINETIS_FAMILY_K6:
            ...
            snprintf(enabling_bit_name, sizeof(enabling_bit_name) - 1,
                DEVICE_PATH_KINETIS_RCC "/AHB1ENR/PORT%dEN",
                1 + state->port_index - KINETIS_PORT_PORT1);
