...
typedef enum {
    ...
    KINETIS_PORT_PORTD,
    KINETIS_PORT_PORTE,
    KINETIS_PORT_PORT_UNDEFINED = 0xFF,
    ...
    union {
      ...
      struct {
        ...
        struct { 
          ...
          Object *dfer; // 0xC0 (Digital Filter Enable Register) 
          Object *dfcr; // 0xC4 (Digital Filter Clock Register) 
          Object *dfwr; // 0xC8 (Digital Filter Width Register) 
        } reg;
        ...
        struct { 
          ...
          // DFER (Digital Filter Enable Register) bitfields.
          struct { 
            Object *dfe; // [0:31] Digital Filter Enable
          } dfer; 

          // DFCR (Digital Filter Clock Register) bitfields.
          struct { 
            Object *cs; // [0:0] Clock Source
          } dfcr; 

          // DFWR (Digital Filter Width Register) bitfields.
          struct { 
            Object *filt; // [0:4] Filter Length
          } dfwr; 
        } fld;
      } k6;
