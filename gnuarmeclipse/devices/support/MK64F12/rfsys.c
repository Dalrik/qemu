...
#include <hw/cortexm/kinetis/rfsys.h>
...
static void mk64f12_rfsys_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
    KinetisRFSYSState *state = KINETIS_RFSYS_STATE(obj);
...
#if 0
static peripheral_register_t kinetis_rfsys_xxx_pre_write_callback(Object *reg,
        Object *periph, uint32_t addr, uint32_t offset, unsigned size,
        peripheral_register_t value, peripheral_register_t full_value)
{
    KinetisRFSYSState *state = KINETIS_RFSYS_STATE(periph);
...
static void kinetis_rfsys_xxx_post_write_callback(Object *reg, Object *periph,
...
static peripheral_register_t kinetis_rfsys_xxx_pre_read_callback(Object *reg,
        Object *periph, uint32_t addr, uint32_t offset, unsigned size)
{
    KinetisRFSYSState *state = KINETIS_RFSYS_STATE(periph);
...
static void kinetis_rfsys_xxx_post_read_callback(Object *reg, Object *periph,
        uint32_t addr, uint32_t offset, unsigned size)
{
    KinetisRFSYSState *state = KINETIS_RFSYS_STATE(periph);
...
static bool kinetis_rfsys_is_enabled(Object *obj)
{
    KinetisRFSYSState *state = KINETIS_RFSYS_STATE(obj);
...
static void kinetis_rfsys_instance_init_callback(Object *obj)
{
...
static void kinetis_rfsys_realize_callback(DeviceState *dev, Error **errp)
{
    qemu_log_function_name();

    // Call parent realize().
    if (!cm_device_parent_realize(dev, errp, TYPE_KINETIS_RFSYS)) {
        return;
    }
    ...
    KinetisRFSYSState *state = KINETIS_RFSYS_STATE(dev);
    ...
    case KINETIS_FAMILY_K6:
            ...
            mk64f12_rfsys_create_objects(obj, cm_state->svd_json, periph_name);
            ...
            // TODO: add callbacks.
            // peripheral_register_set_pre_read(state->k6.reg.xxx, &kinetis_rfsys_xxx_pre_read_callback);
            // peripheral_register_set_post_read(state->k6.reg.xxx, &kinetis_rfsys_xxx_post_read_callback);
            // peripheral_register_set_pre_read(state->k6.reg.xxx, &kinetis_rfsys_xxx_pret_read_callback);
            // peripheral_register_set_post_write(state->k6.reg.xxx, &kinetis_rfsys_xxx_post_write_callback);

            // TODO: add interrupts.

            // TODO: remove this if the peripheral is always enabled.
            snprintf(enabling_bit_name, sizeof(enabling_bit_name) - 1,
                DEVICE_PATH_KINETIS_RCC "/AHB1ENR/RFSYSEN");
...
static void kinetis_rfsys_reset_callback(DeviceState *dev)
{
    qemu_log_function_name();

    // Call parent reset(); this will reset all children registers.
    cm_device_parent_reset(dev, TYPE_KINETIS_RFSYS);
}

static void kinetis_rfsys_class_init_callback(ObjectClass *klass, void *data)
{
    DeviceClass *dc = DEVICE_CLASS(klass);

    dc->reset = kinetis_rfsys_reset_callback;
    dc->realize = kinetis_rfsys_realize_callback;

    // TODO: remove this if the peripheral is always enabled.
    PeripheralClass *per_class = PERIPHERAL_CLASS(klass);
    per_class->is_enabled = kinetis_rfsys_is_enabled;
}

static const TypeInfo kinetis_rfsys_type_info = {
    .name = TYPE_KINETIS_RFSYS,
    .parent = TYPE_KINETIS_RFSYS_PARENT,
    .instance_init = kinetis_rfsys_instance_init_callback,
    .instance_size = sizeof(KinetisRFSYSState),
    .class_init = kinetis_rfsys_class_init_callback,
    .class_size = sizeof(KinetisRFSYSClass) };

static void kinetis_rfsys_register_types(void)
{
    type_register_static(&kinetis_rfsys_type_info);
}

type_init(kinetis_rfsys_register_types);
