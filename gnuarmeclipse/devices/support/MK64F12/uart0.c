...
static void mk64f12_uart_create_objects(Object *obj, JSON_Object *svd, const char *name)
{
    ...
    state->u.k6.reg.c7816 = cm_object_get_child_by_name(obj, "C7816");
    state->u.k6.reg.ie7816 = cm_object_get_child_by_name(obj, "IE7816");
    state->u.k6.reg.is7816 = cm_object_get_child_by_name(obj, "IS7816");
    state->u.k6.reg.wp7816t0 = cm_object_get_child_by_name(obj, "WP7816T0");
    state->u.k6.reg.wp7816t1 = cm_object_get_child_by_name(obj, "WP7816T1");
    state->u.k6.reg.wn7816 = cm_object_get_child_by_name(obj, "WN7816");
    state->u.k6.reg.wf7816 = cm_object_get_child_by_name(obj, "WF7816");
    state->u.k6.reg.et7816 = cm_object_get_child_by_name(obj, "ET7816");
    state->u.k6.reg.tl7816 = cm_object_get_child_by_name(obj, "TL7816");
    ...
    // C7816 bitfields.
    state->u.k6.fld.c7816.iso_7816e = cm_object_get_child_by_name(state->u.k6.reg.c7816, "ISO_7816E");
    state->u.k6.fld.c7816.ttype = cm_object_get_child_by_name(state->u.k6.reg.c7816, "TTYPE");
    state->u.k6.fld.c7816.init = cm_object_get_child_by_name(state->u.k6.reg.c7816, "INIT");
    state->u.k6.fld.c7816.anack = cm_object_get_child_by_name(state->u.k6.reg.c7816, "ANACK");
    state->u.k6.fld.c7816.onack = cm_object_get_child_by_name(state->u.k6.reg.c7816, "ONACK");

    // IE7816 bitfields.
    state->u.k6.fld.ie7816.rxte = cm_object_get_child_by_name(state->u.k6.reg.ie7816, "RXTE");
    state->u.k6.fld.ie7816.txte = cm_object_get_child_by_name(state->u.k6.reg.ie7816, "TXTE");
    state->u.k6.fld.ie7816.gtve = cm_object_get_child_by_name(state->u.k6.reg.ie7816, "GTVE");
    state->u.k6.fld.ie7816.initde = cm_object_get_child_by_name(state->u.k6.reg.ie7816, "INITDE");
    state->u.k6.fld.ie7816.bwte = cm_object_get_child_by_name(state->u.k6.reg.ie7816, "BWTE");
    state->u.k6.fld.ie7816.cwte = cm_object_get_child_by_name(state->u.k6.reg.ie7816, "CWTE");
    state->u.k6.fld.ie7816.wte = cm_object_get_child_by_name(state->u.k6.reg.ie7816, "WTE");

    // IS7816 bitfields.
    state->u.k6.fld.is7816.rxt = cm_object_get_child_by_name(state->u.k6.reg.is7816, "RXT");
    state->u.k6.fld.is7816.txt = cm_object_get_child_by_name(state->u.k6.reg.is7816, "TXT");
    state->u.k6.fld.is7816.gtv = cm_object_get_child_by_name(state->u.k6.reg.is7816, "GTV");
    state->u.k6.fld.is7816.initd = cm_object_get_child_by_name(state->u.k6.reg.is7816, "INITD");
    state->u.k6.fld.is7816.bwt = cm_object_get_child_by_name(state->u.k6.reg.is7816, "BWT");
    state->u.k6.fld.is7816.cwt = cm_object_get_child_by_name(state->u.k6.reg.is7816, "CWT");
    state->u.k6.fld.is7816.wt = cm_object_get_child_by_name(state->u.k6.reg.is7816, "WT");

    // WP7816T0 bitfields.
    state->u.k6.fld.wp7816t0.wi = cm_object_get_child_by_name(state->u.k6.reg.wp7816t0, "WI");

    // WP7816T1 bitfields.
    state->u.k6.fld.wp7816t1.bwi = cm_object_get_child_by_name(state->u.k6.reg.wp7816t1, "BWI");
    state->u.k6.fld.wp7816t1.cwi = cm_object_get_child_by_name(state->u.k6.reg.wp7816t1, "CWI");

    // WN7816 bitfields.
    state->u.k6.fld.wn7816.gtn = cm_object_get_child_by_name(state->u.k6.reg.wn7816, "GTN");

    // WF7816 bitfields.
    state->u.k6.fld.wf7816.gtfd = cm_object_get_child_by_name(state->u.k6.reg.wf7816, "GTFD");

    // ET7816 bitfields.
    state->u.k6.fld.et7816.rxthreshold = cm_object_get_child_by_name(state->u.k6.reg.et7816, "RXTHRESHOLD");
    state->u.k6.fld.et7816.txthreshold = cm_object_get_child_by_name(state->u.k6.reg.et7816, "TXTHRESHOLD");

    // TL7816 bitfields.
    state->u.k6.fld.tl7816.tlen = cm_object_get_child_by_name(state->u.k6.reg.tl7816, "TLEN");
}
