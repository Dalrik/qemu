    ...
    union {
      ...
      struct {
        ...
        struct { 
          ...
          Object *c7816; // 0x18 (UART 7816 Control Register) 
          Object *ie7816; // 0x19 (UART 7816 Interrupt Enable Register) 
          Object *is7816; // 0x1A (UART 7816 Interrupt Status Register) 
          Object *wp7816t0; // 0x1B (UART 7816 Wait Parameter Register) 
          Object *wp7816t1; // 0x1B (UART 7816 Wait Parameter Register) 
          Object *wn7816; // 0x1C (UART 7816 Wait N Register) 
          Object *wf7816; // 0x1D (UART 7816 Wait FD Register) 
          Object *et7816; // 0x1E (UART 7816 Error Threshold Register) 
          Object *tl7816; // 0x1F (UART 7816 Transmit Length Register) 
        } reg;
        ...
        struct { 
          ...
          // C7816 (UART 7816 Control Register) bitfields.
          struct { 
            Object *iso_7816e; // [0:0] ISO-7816 Functionality Enabled
            Object *ttype; // [1:1] Transfer Type
            Object *init; // [2:2] Detect Initial Character
            Object *anack; // [3:3] Generate NACK on Error
            Object *onack; // [4:4] Generate NACK on Overflow
          } c7816; 

          // IE7816 (UART 7816 Interrupt Enable Register) bitfields.
          struct { 
            Object *rxte; // [0:0] Receive Threshold Exceeded Interrupt Enable
            Object *txte; // [1:1] Transmit Threshold Exceeded Interrupt Enable
            Object *gtve; // [2:2] Guard Timer Violated Interrupt Enable
            Object *initde; // [4:4] Initial Character Detected Interrupt Enable
            Object *bwte; // [5:5] Block Wait Timer Interrupt Enable
            Object *cwte; // [6:6] Character Wait Timer Interrupt Enable
            Object *wte; // [7:7] Wait Timer Interrupt Enable
          } ie7816; 

          // IS7816 (UART 7816 Interrupt Status Register) bitfields.
          struct { 
            Object *rxt; // [0:0] Receive Threshold Exceeded Interrupt
            Object *txt; // [1:1] Transmit Threshold Exceeded Interrupt
            Object *gtv; // [2:2] Guard Timer Violated Interrupt
            Object *initd; // [4:4] Initial Character Detected Interrupt
            Object *bwt; // [5:5] Block Wait Timer Interrupt
            Object *cwt; // [6:6] Character Wait Timer Interrupt
            Object *wt; // [7:7] Wait Timer Interrupt
          } is7816; 

          // WP7816T0 (UART 7816 Wait Parameter Register) bitfields.
          struct { 
            Object *wi; // [0:7] Wait Time Integer (C7816[TTYPE] = 0)
          } wp7816t0; 

          // WP7816T1 (UART 7816 Wait Parameter Register) bitfields.
          struct { 
            Object *bwi; // [0:3] Block Wait Time Integer(C7816[TTYPE] = 1)
            Object *cwi; // [4:7] Character Wait Time Integer (C7816[TTYPE] = 1)
          } wp7816t1; 

          // WN7816 (UART 7816 Wait N Register) bitfields.
          struct { 
            Object *gtn; // [0:7] Guard Band N
          } wn7816; 

          // WF7816 (UART 7816 Wait FD Register) bitfields.
          struct { 
            Object *gtfd; // [0:7] FD Multiplier
          } wf7816; 

          // ET7816 (UART 7816 Error Threshold Register) bitfields.
          struct { 
            Object *rxthreshold; // [0:3] Receive NACK Threshold
            Object *txthreshold; // [4:7] Transmit NACK Threshold
          } et7816; 

          // TL7816 (UART 7816 Transmit Length Register) bitfields.
          struct { 
            Object *tlen; // [0:7] Transmit Length
          } tl7816; 
        } fld;
      } k6;
